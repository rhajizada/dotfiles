...
def main():
    ...
    parser.add_argument("-i", "--input", type=file_exists, required=True, help="Path to the Makefile")
    parser.add_argument("-o", "--output", type=str, help="Output file to save the formatted Makefile")
    parser.add_argument('--dry-run', action='store_true', help='Run the formatter without making any changes')
